...
namespace MyPegasus.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly PegasusContext _context;

        public AccountController(IPegasusContext context)
        {
            // TODO: Use service rather than context
            _context = (PegasusContext)context;
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = Account.Create(model.FirstName, model.LastName, model.Email);
